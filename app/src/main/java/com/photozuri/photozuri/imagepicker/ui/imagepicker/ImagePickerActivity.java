...
import com.photozuri.photozuri.imagepicker.helper.CameraHelper;
import com.photozuri.photozuri.imagepicker.helper.LogHelper;
import com.photozuri.photozuri.imagepicker.helper.PermissionHelper;
...
import com.photozuri.photozuri.imagepicker.widget.ImagePickerToolbar;
import com.photozuri.photozuri.imagepicker.widget.ProgressWheel;
import com.photozuri.photozuri.imagepicker.widget.SnackBarView;
...
public class ImagePickerActivity extends AppCompatActivity implements ImagePickerView {
    ...
    private OnImageClickListener imageClickListener = new OnImageClickListener() {
        ...
        public boolean onImageClick(View view, int position, boolean isSelected) {
            setCount(recyclerViewManager.getSelectedImages().size());
        ...
        recyclerViewManager.setOnImageSelectionListener(new OnImageSelectionListener() {
            ...
            public void onSelectionUpdate(List<Image> images) {
                ...
                if (!config.isMultipleMode() && !images.isEmpty()) {
                    onDone();
                    Toast.makeText(ImagePickerActivity.this, "" + images.size(), Toast.LENGTH_LONG).show();
    ...
    private void invalidateToolbar() {
        ...
        toolbar.setCount(recyclerViewManager.getSelectedImages().size());
