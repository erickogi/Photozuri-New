...
import com.photozuri.photozuri.Adapter.PassportsProcessStepperAdapter;
...
public class Passports extends AppCompatActivity implements StepperLayout.StepperListener {
    private StepperLayout mStepperLayout;
    private PassportsProcessStepperAdapter mStepperAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStepperAdapter = new PassportsProcessStepperAdapter(getSupportFragmentManager(), this);
    ...
    public void onCompleted(View completeButton) {
        ...
        startActivity(new Intent(Passports.this, Payments.class));
        finish();
    }
