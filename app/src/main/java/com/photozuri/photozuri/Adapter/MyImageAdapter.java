...
public class MyImageAdapter extends RecyclerView.Adapter<MyImageAdapter.MyImageViewHolder> {
    ...
    public MyImageAdapter(Context context, ArrayList<MyImage> myImages, OnclickRecyclerListener listener) {
...
//    }
    ...
    public void onBindViewHolder(MyImageViewHolder holder, int position) {
        ...
        if (image.getCaption() == null || image.getCaption().equals("Add caption")) {
            holder.textViewCaption.setText("*1");
        } else {
