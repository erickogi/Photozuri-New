...
import com.photozuri.photozuri.Views.V1.Fragments.Passports.FragmentPpsTwo;
...
public class PassportsProcessStepperAdapter extends AbstractFragmentStepAdapter {
    private static final String CURRENT_STEP_POSITION_KEY = "messageResourceId";

    public PassportsProcessStepperAdapter(FragmentManager fm, Context context) {
        super(fm, context);
    }
    ...
    public Step createStep(int position) {
        switch (position) {
            case 0:
                ...
                return step1;
            case 1:
                final FragmentPpsTwo step2 = new FragmentPpsTwo();
                Bundle b2 = new Bundle();
                b2.putInt(CURRENT_STEP_POSITION_KEY, position);
                step2.setArguments(b2);
                return step2;
//            case 2:
//                final FragmentPpsThree step3 = new FragmentPpsThree();
...
//                return step3;
    ...
    public StepViewModel getViewModel(@IntRange(from = 0) int position) {
        ...
        switch (position) {
            ...
            case 1:
                return new StepViewModel.Builder(context)
                        .setTitle("Edit") //can be a CharSequence instead
                        .create();
            case 2:
                return new StepViewModel.Builder(context)
