...
public class PhotoFullPopupWindow3 extends PopupWindow {

    private static PhotoFullPopupWindow3 instance = null;
    View view;
    Context mContext;
    PhotoView photoView;
    ProgressBar loading;
    ...
    public PhotoFullPopupWindow3(Context ctx, int layout, View v, String imageUrl, Bitmap bitmap) {
...
//                    .into(photoView);
    ...
    public PhotoFullPopupWindow3(Context ctx,
                                 int layout,
    ...
    public void start(PhotoPopUpListner listener) {
        ...
        if (!caption.isEmpty()) {
            ...
            textCaption.setText("Add caption");
        }
