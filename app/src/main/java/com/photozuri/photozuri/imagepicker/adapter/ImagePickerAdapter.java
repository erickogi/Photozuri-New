package com.photozuri.photozuri.imagepicker.adapter;
...
import com.photozuri.photozuri.imagepicker.helper.ImageHelper;
...
import com.photozuri.photozuri.imagepicker.ui.common.BaseRecyclerViewAdapter;
import com.photozuri.photozuri.imagepicker.ui.imagepicker.ImageLoader;
...
public class ImagePickerAdapter extends BaseRecyclerViewAdapter<ImagePickerAdapter.ImageViewHolder> {
    ...
    public ImagePickerAdapter(Context context, ImageLoader imageLoader, List<Image> selectedImages, OnImageClickListener itemClickListener, AddRemove addRemove) {
    ...
    public void addSelected(Image image, int position) {
        ...
        //addRemove.onImageAdd(selectedImages.size());
    }
    ...
    public void removeSelected(Image image, int position) {
        ...
        // addRemove.onImageRemove(selectedImages.size());
    }
