...
import com.photozuri.photozuri.Views.V1.Fragments.Photobook.FragmentThree;
import com.photozuri.photozuri.Views.V1.Fragments.Photobook.FragmentTwo;
...
public class PhotoProcessStepperAdapter extends AbstractFragmentStepAdapter {
    private static final String CURRENT_STEP_POSITION_KEY = "messageResourceId";

    public PhotoProcessStepperAdapter(FragmentManager fm, Context context) {
        super(fm, context);
    }
    ...
    public StepViewModel getViewModel(@IntRange(from = 0) int position) {
        ...
        switch (position) {
            ...
            case 1:
                return new StepViewModel.Builder(context)
                        .setTitle("Captions/Arrange") //can be a CharSequence instead
                        .create();
            case 2:
                return new StepViewModel.Builder(context)
