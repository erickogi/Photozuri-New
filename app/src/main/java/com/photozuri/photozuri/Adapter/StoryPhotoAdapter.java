...
public class StoryPhotoAdapter extends RecyclerView.Adapter<StoryPhotoAdapter.MyImageViewHolder> {

    private Context context;
    private ArrayList<StoryPhoto> images;

    private RequestOptions options;
    private OnclickRecyclerListener recyclerListener;

    public StoryPhotoAdapter(Context context, ArrayList<StoryPhoto> myImages, OnclickRecyclerListener listener) {
...
//    }
    ...
    public void setData(List<StoryPhoto> images) {
        this.images.clear();
        if (images != null) {
...
//            imageView.setOnClickListener(this);
        ...
        public void onClick(View v) {
            ...
            if (v.getId() == R.id.image_thumbnail) {
