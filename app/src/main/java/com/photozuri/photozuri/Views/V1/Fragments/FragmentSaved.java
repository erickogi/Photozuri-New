...
public class FragmentSaved extends Fragment {
    ...
    private void initView(View view) {
        ...
        List<TimeLineModel> timeLineModels = testDataGen.getInSaved();
        mTimeLineAdapter = new TimeLineAdapter(true, getMyContext(), timeLineModels, mOrientation, mWithLinePadding, new OnclickRecyclerListener() {
            @Override
            public void onClickListener(int position) {
                ...
                if (titleModel.getImage_status() == DbConstants.saved) {
                    intent = new Intent(getActivity(), Payments.class);
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        try {
                            if (getActivity() != null) {
                                ((ProductsActivity) getActivity()).setCount();
                            }
                        } catch (Exception nm) {
                            nm.printStackTrace();
                        }
