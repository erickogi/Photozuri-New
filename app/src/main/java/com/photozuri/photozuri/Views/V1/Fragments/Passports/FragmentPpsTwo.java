...
import com.photozuri.photozuri.Utills.PhotoFullPopupWindow2;
...
public class FragmentPpsTwo extends Fragment implements BlockingStep {
    ...
    void initUI(View view) {
        ...
        adapter = new MyImageAdapter(getContext(), myImages, new OnclickRecyclerListener() {
            @Override
            public void onClickListener(int position) {

                Log.d("pps", "onClicked started");
                MyImage myImage = myImages.get(position);
                PhotoFullPopupWindow2 p = new PhotoFullPopupWindow2(getContext(),
                        R.layout.popup_photo_full_pss2,
